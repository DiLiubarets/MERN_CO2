...
import { setCurrentLocation, getWeatherData, setFetchingTrue, clearLocation } from '../../redux/actions';
...
const LocationButton = ({ setLocation, getWeatherData, setFetching }) => {
    ...
    return (
        <div>
                    <button onClick={handleClick} className="green-btn btn-small">Current Location</button>
        </div>
    )   
}
